...
public class UsuarioDao {
	...
	public Usuario buscaPorLogin(String login) { // faz sentido deletar por login?
		if (login == null) {
		...
		try {
			...
			if (rs.next()) { // assume que nao tem repeticao
				...
				usuario = new Usuario(log, nome, sobrenome, senha);
			}
		...
		return usuario; // pode retornar o ResultSet ou Nulo
	}
