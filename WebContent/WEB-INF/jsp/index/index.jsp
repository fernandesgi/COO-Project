							...
							<div class="col-lg-12">
								<form id="login-form" action="autentica" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="usuario.login" id="username" tabindex="1" class="form-control" placeholder="Email" value="" required>
									</div>
									<div class="form-group">
								...
								<form id="register-form" action="registra" method="post" role="form" style="display: none;">
									<div class="form-group">
										<input type="text" name="usuario.nome" id="nome" tabindex="1" class="form-control" placeholder="Nome" value="" required>
									</div>
									<div class="form-group">
										<input type="text" name="usuario.sobrenome" id="sobrenome" tabindex="1" class="form-control" placeholder="Sobrenome" value="" required>
									</div>
									<div class="form-group">
										<input type="email" name="usuario.login" id="email" tabindex="1" class="form-control" placeholder="Endereço de Email" value="" required>
									</div>
									<div class="form-group">
										<input type="password" name="usuario.password" id="password" tabindex="2" class="form-control" placeholder="Senha" required>
									</div>
									<div class="form-group">
										<input type="password" name="confirm-password" id="confirm-password" tabindex="2" class="form-control" placeholder="Confirme a Senha" required>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
